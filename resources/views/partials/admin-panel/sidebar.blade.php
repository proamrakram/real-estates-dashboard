    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="{{ route('panel.home') }}"><span
                            class="brand-logo">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('panel.home') }}"><i
                            ...
                            data-i18n="Email">الصفحة الرئيسية</span></a>
                </li>

                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('panel.users') }}"><i
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('panel.clients') }}"><i
                            data-feather="users"></i><span class="menu-title text-truncate"
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('panel.mediators') }}"><i
