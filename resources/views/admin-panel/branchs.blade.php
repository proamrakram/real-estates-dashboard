                                                ...
                                                <div id="create-app-details" class="content" role="tabpanel"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-1">
                                                            <label class="form-label" for="branch_name">الاسم</label>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body pb-5 px-sm-4 mx-50">
                                        <h1 class="address-title text-center mb-1" id="addNewAddressTitle">إضافة فرع</h1>
                                        ...
                                        <form  id="addNewAddressForm" class="row gy-1 gx-2" >
                                            ...
                                            <div class="col-12 col-md-6">
                                                <label class="form-label" for="branch_code">كود الفرع</label>
                                                <input type="" id="branch_code" name="branch_code"
