                                    ...
                                    <table class="datatables-basic table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> 0900000 </td>
                                                <td>مكة</td>
                                                <td> <span class="badge bg-dark"> قطاع عام</span></td>
                                                <td>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body pb-5 px-sm-4 mx-50">
                                        <h1 class="address-title text-center mb-1" id="addNewAddressTitle">إنشاء حساب عميل
                                        </h1>
                                        ...
                                        <form id="addNewAddressForm" class="row gy-1 gx-2" onsubmit="return false">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <label class="form-label" for="modalAddressFirstName">البريد
                                                    الإلكتروني</label>
                                                <input type="text" id="modalAddressEmail" name="modalAddressEmail"
                                                    class="form-control" placeholder="الايميل" />
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label class="form-label" for="modalAddressLastName">رقم الهوية
                                                    الوطنية</label>
                                                <input type="" id="modalAddressNID" name="modalAddressNID"
                                                    class="form-control" placeholder="رقم الهوية الوطنية" />
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label" for="modalAddressCountry">المنطقة</label>
                                                <select id="modalAddressCountry" name="modalAddressCountry"
                                                    class="select2 form-select">
                                                    <option value="">اختيار المنطقة</option>
                                                    <option value="1">جزيرة تاروت</option>
                                            ...
                                            <div class="col-12 col-md-6">
                                                <label class="form-label" for="modalAddressBID">رقم المبنى</label>
                                                <input type="" id="modalAddressBID" name="modalAddressBID"
                                                    class="form-control" placeholder="رقم المبنى" />
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label class="form-label" for="modalAddressStreetName">اسم الشارع</label>
                                                <input type="" id="modalAddressStreetName"
                                                    name="modalAddressStreetName" class="form-control"
                                                    placeholder="اسم الشارع" />
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label class="form-label" for="modalAddressDistName">اسم الحي</label>
                                                <input type="" id="modalAddressDistName"
                                                    name="modalAddressDistName" class="form-control"
                                                    placeholder="اسم الحي" />
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label class="form-label" for="modalAddressZipCode">الرمز البريدي</label>
                                                <input type="" id="modalAddressZipCode" name="modalAddressZipCode"
                                                    class="form-control" placeholder="الرمز البريدي" />
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label class="form-label" for="modalAddressZipCode">الرقم الإضافي</label>
                                                <input type="" id="modalAddressAddNum" name="modalAddressAddNum"
                                                    class="form-control" placeholder="الرقم الاضافي" />
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <label class="form-label" for="modalAddressUnitNum">رقم الوحدة</label>
                                                <input type="" id="modalAddressUnitNum" name="modalAddressUnitNum"
                                                    class="form-control" placeholder="رقم الوحدة" />
                                            </div>
                                            <div class="col-12 col-md-6">
