<div class="content-header-right  col-md-3 col-12 d-md-block d-none">
    ...
    <div class="mb-1 text-md-end breadcrumb-right">
        <a href="javascript:;" data-bs-target="#createOrderModal" data-bs-toggle="modal" class="btn btn-primary">
            <span>
                <i data-feather='plus-square'></i>
                انشاء طلب جديد</span></a>
    </div>
                    ...
                    <div class="bs-stepper vertical wizard-modern create-app-wizard">
                        ...
                        <div class="bs-stepper-content shadow-none" wire:ignore.self>
                            ...
                            <div id="create-app-frameworks" class="content" role="tabpanel"
                                aria-labelledby="create-app-frameworks-trigger" wire:ignore.self>
                            ...
                            <div id="create-app-database" class="content" role="tabpanel"
                                aria-labelledby="create-app-database-trigger" wire:ignore.self>
