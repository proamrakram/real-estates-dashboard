...
class CustomerService extends Controller
{
    ...
    public function store($data)
    {
        $customer = Customer::create([
            ...
            'nationality_id' => $data['identification_number'] == "" ? null : null,
            // 'NID'  => $this->request->nationality_id,
            'city_id' => $data['city_id'] == "" ? null : null,
            'building_number' => $data['building_number'] == "" ? null : null,
            'street_name' => $data['street_name'] == "" ? null : null,
            'neighborhood_name' => $data['neighborhood_name'] == "" ? null : null,
            'zip_code' => $data['zip_code'] == "" ? null : null,
            'addtional_number' => $data['additional_number'] == "" ? null : null,
            'unit_number' => $data['unit_number'] == "" ? null : null,
            'support_eskan' => $data['is_support'] == "yes" ? 1 : 0,
            'employee_type' => $data['employee_type'] == "" ? null : null,
            'status' => $data['status']
            // 'who_add',
            // 'who_edit',
        ]);
